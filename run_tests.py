...
class ExampleRunner(object):
    ...
    def alter_argv(self, args):
        #proboscis._default_argv = sys.argv[:2] + args
...
#    output_file = join(output_directory, "output.txt")
#    make_dirs(output_directory)
#    output = open(output_file, 'w')
#
#    # Disable unittest's habit of murdering program on invocation.
...
#        sys.exit = old_sys_exit
#
#        assert_failures_in_file(output_file, test.failures)
#        create_rst("bash", output_file, join(output_directory, "output.rst"))
